...
class SupporterSignupTest {
  ...
  void supporterSignupIdDuplicateTest() {
    // 중복 id userDto
    int k=userRepository.findAll().size();
  ...
  void supporterSignupNameDuplicateTest() {
    // 중복 name userDto
    int k=userRepository.findAll().size();
  ...
  void supporterSignupIdIsBlankTest() {
    // 빈 principal userDto
    int k=userRepository.findAll().size();
  ...
  @Test
  @DisplayName("빈 principal exception 테스트")
  void supporterSignupCredentialIsBlankTest() {
  ...
  void supporterSignupNameIsBlankTest() {
    // 빈 name userDto
    int k=userRepository.findAll().size();
  ...
  void supporterSignupPrincipalExpressionValidateTest() {
  ...
  void supporterSignupCredentialExpressionValidateTest() {
  ...
  @Test
  @DisplayName("credential 정규식 exception 테스트")
  void supporterSignupNameExpressionValidateTest() {
    // 정규식에 맞지 않는 credential userDto
    int k=userRepository.findAll().size();
